  ...
  return (
    <div className= {` flex flex-col justify-center items-center ${details ? ' w-full max-w-105 ms-auto ' : ''  }`}>
        ...
        <form className=' flex flex-wrap md:flex-nowrap gap-4 m-auto'>
            <input className='w-full max-w-85 h-12 text-base text-mythird border border-solid rounded-lg  border-inputborder indent-3 ' type='email' placeholder={holder}></input>
